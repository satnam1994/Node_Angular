...
let RealBackendInterceptor = class RealBackendInterceptor {
    intercept(request, next) {
...
let AuthenticationService = class AuthenticationService {
    ...
    register(firstName, lastName, user_email, password) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/register`, { firstName, lastName, user_email, password })
